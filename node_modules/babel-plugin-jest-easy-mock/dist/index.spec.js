...
it("Doesn't do if there won't be jest.mockObj calls", () => {
    const source = `
        ...
        jest.dontMock("b");
    `;
    expect(core_1.transform(source, { plugins: [_1.default] }).code).toMatchSnapshot();
    expect(core_1.transform(source, { plugins: [[_1.default, { requireActual: true }]], }).code).toMatchSnapshot();
});
...
it("Correct spread for overwritten deeplevel", () => {
    ...
    `;
    expect(core_1.transform(source, { plugins: [[_1.default, { requireActual: true }]], }).code).toMatchSnapshot();
    expect(core_1.transform(source2, { plugins: [[_1.default, { requireActual: true }]], }).code).toMatchSnapshot();
});
it("Works with custom identifiers", () => {
    ...
    expect(core_1.transform(source, { plugins: [[_1.default, { identifiers: customIdentifiers }]] }).code).toMatchSnapshot();
    expect(core_1.transform(source, { plugins: [[_1.default, { requireActual: true, identifiers: customIdentifiers }]], }).code).toMatchSnapshot();
});
